export const CONTACT_INFO = {
  ...
  address: {
    street: "Calle Francisco Bolognesi, 169",
    city: "Paijan, La Libertad, Perú",
  },
  social: {
    facebook: "https://www.facebook.com/grupoqbcontadoresyasesores",
    instagram: "https://instagram.com/grupobq",
    linkedin:
...
export const COMPANY_INFO = {
  ...
  description:
    "Más de 15 años ayudando a empresas y emprendedores a mantener sus finanzas en orden.",

  about: [
    {
      parts: [
        {
          text: "Grupo BQ Contadores y Asesores",
          strong: true,
    ...
    {
      parts: [
        { text: "Nuestro enfoque se basa en la " },
        { text: "ética", strong: true },
        { text: ", la " },
        { text: "actualización constante", strong: true },
        { text: " y una " },
  ...
  founder: {
    name: "Segundo Armando Bautista Rojas",
    title: "Contador Público Colegiado",
    location: "Paijan, La Libertad - Perú",
    university: "ULADECH Católica",
    experience: "+10 años de experiencia profesional",
    specialty: "Especialista en PYMES",
  },
};
